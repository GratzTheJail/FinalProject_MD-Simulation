...
{ 
    ...
    REQUIRE_THAT(particles[0].vel().y(), Catch::Matchers::WithinAbs( 0.0,1E-9));

    REQUIRE_THAT(particles[1].vel().x(), Catch::Matchers::WithinAbs(1.0,1E-9));
